<template>
  <div class="custom_textarea_box">
    <a-textarea ref="textarea" class="custom_textarea" :model-value="modelValue" @input="calculateRowsOutOne" @update:modelValue="onUpdateModelValue"
      :auto-size="autoSize" :max-length="maxLength" show-word-limit
...
const textarea = ref();
const props = defineProps(['modelValue','maxLength','placeholder','autoSize','height'])
